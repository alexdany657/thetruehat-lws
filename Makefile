...
tth.d: tth.d.o tth_codes.d.o tth_callbacks.d.o tth_signals.d.o tth_json.d.o lib/libcJSON.so tth_timeout.d.o
	gcc -o tth.d tth.d.o tth_codes.d.o tth_callbacks.d.o tth_signals.d.o tth_json.d.o tth_timeout.d.o $(LD_FLAGS_D) -lwebsockets -lcJSON -L/usr/lib64/mysql -lmysqlclient

tth: tth.o tth_codes.o tth_callbacks.o tth_signals.o tth_json.o lib/libcJSON.so tth_timeout.o
	gcc -o tth tth.o tth_codes.o tth_callbacks.o tth_signals.o tth_json.o tth_timeout.o -lwebsockets -Llib -lcJSON -L/usr/lib64/mysql -lmysqlclient
